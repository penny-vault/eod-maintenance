...
const (
	binaryName  = "eod-maintenance"
	packageName = "."
	module      = "github.com/penny-vault/eod-maintenance"
)
...
func ldFlags() string {
	embeddedVars := map[string]string{
		"pkginfo.CommitHash": "COMMIT_HASH",
		"pkginfo.BuildDate":  "BUILD_DATE",
		"pkginfo.Version":    "SW_VERSION",
	}
...
var (
	pkgPrefixLen = len("github.com/penny-vault/eod-maintenance")
	pkgs         []string
	pkgsInit     sync.Once
)
